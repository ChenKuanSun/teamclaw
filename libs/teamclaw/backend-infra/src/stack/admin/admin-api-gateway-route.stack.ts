...
export class AdminApiGatewayRouteStack extends Stack {
  constructor(scope: Construct, id: string, props: StackPropsWithEnv) {
    super(scope, id, {
      ...props,
      description: 'TeamClaw Admin: API Gateway Routes',
    });
    ...
    addRoute(
      ...
      getLambda(
        'GetOnboardingStatusLambda',
        ADMIN_LAMBDA_SSM.GET_ONBOARDING_STATUS_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      '/admin/skills/review',
      getLambda(
        'ReviewSkillRequestLambda',
        ADMIN_LAMBDA_SSM.REVIEW_SKILL_REQUEST_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      getLambda(
        'ListPendingSkillsLambda',
        ADMIN_LAMBDA_SSM.LIST_PENDING_SKILLS_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      getLambda(
        'ListApprovedSkillsLambda',
        ADMIN_LAMBDA_SSM.LIST_APPROVED_SKILLS_LAMBDA_NAME,
      ),
    );

    // ==========================================================
    // INTEGRATIONS ROUTES (Admin): /admin/integrations,
    ...
    addRoute(
      ...
      getLambda(
        ...
        ADMIN_LAMBDA_SSM.LIST_INTEGRATIONS_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      getLambda(
        ...
        ADMIN_LAMBDA_SSM.GET_INTEGRATION_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      getLambda(
        ...
        ADMIN_LAMBDA_SSM.UPDATE_INTEGRATION_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      '/admin/integrations/{integrationId}',
      getLambda(
        'DeleteIntegrationCredLambda',
        ADMIN_LAMBDA_SSM.DELETE_INTEGRATION_CRED_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      '/admin/integrations/{integrationId}/teams',
      getLambda(
        'ListTeamOverridesLambda',
        ADMIN_LAMBDA_SSM.LIST_TEAM_OVERRIDES_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      '/admin/integrations/{integrationId}/teams/{teamId}',
      getLambda(
        'UpdateTeamOverrideLambda',
        ADMIN_LAMBDA_SSM.UPDATE_TEAM_OVERRIDE_LAMBDA_NAME,
      ),
    );
    ...
    addRoute(
      ...
      '/admin/integrations/{integrationId}/teams/{teamId}',
      getLambda(
        'DeleteTeamCredLambda',
        ADMIN_LAMBDA_SSM.DELETE_TEAM_CRED_LAMBDA_NAME,
      ),
    );

    // ==========================================================
    // INTEGRATIONS ROUTES (User): /user/integrations,
    //   /user/integrations/{integrationId}/connect,
    //   /user/integrations/{integrationId}/disconnect
    // ==========================================================
    const listUserIntegrationsLambda = getLambda(
      'ListUserIntegrationsLambda',
      ADMIN_LAMBDA_SSM.LIST_USER_INTEGRATIONS_LAMBDA_NAME,
    );

    new HttpRoute(this, id + 'ListUserIntegrations', {
      httpApi: adminHttpApi as aws_apigatewayv2.IHttpApi,
      integration: new HttpLambdaIntegration(
        id + 'ListUserIntegrationsIntegration',
        listUserIntegrationsLambda,
      ),
      routeKey: HttpRouteKey.with('/user/integrations', HttpMethod.GET),
      authorizer: chatAuthorizer,
    });

    const connectIntegrationLambda = getLambda(
      'ConnectIntegrationLambda',
      ADMIN_LAMBDA_SSM.CONNECT_INTEGRATION_LAMBDA_NAME,
    );

    new HttpRoute(this, id + 'ConnectIntegration', {
      httpApi: adminHttpApi as aws_apigatewayv2.IHttpApi,
      integration: new HttpLambdaIntegration(
        id + 'ConnectIntegrationIntegration',
        connectIntegrationLambda,
      ),
    ...
    const disconnectIntegrationLambda = getLambda(
      'DisconnectIntegrationLambda',
      ADMIN_LAMBDA_SSM.DISCONNECT_INTEGRATION_LAMBDA_NAME,
    );

    new HttpRoute(this, id + 'DisconnectIntegration', {
      httpApi: adminHttpApi as aws_apigatewayv2.IHttpApi,
      integration: new HttpLambdaIntegration(
        id + 'DisconnectIntegrationIntegration',
        disconnectIntegrationLambda,
      ),
      routeKey: HttpRouteKey.with(
        '/user/integrations/{integrationId}/disconnect',
