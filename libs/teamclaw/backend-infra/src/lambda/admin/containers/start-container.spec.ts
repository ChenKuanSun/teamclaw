...
const makeEvent = (overrides: Partial<APIGatewayProxyEventV2WithJWTAuthorizer> = {}): APIGatewayProxyEventV2WithJWTAuthorizer =>
  ({
    version: '2.0',
    routeKey: 'POST /admin/containers/{userId}/start',
    rawPath: '/admin/containers/u1/start',
    rawQueryString: '',
    headers: {},
    requestContext: {
      http: { method: 'POST', path: '/admin/containers/u1/start', protocol: 'HTTP/1.1', sourceIp: '127.0.0.1', userAgent: 'test' },
