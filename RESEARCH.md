...
apps/
  infra-foundation/teamclaw-foundation-infra/
  infra-cluster/teamclaw-cluster-infra/
  infra-control-plane/teamclaw-control-plane-infra/
  web-chat/     # Angular 21 + Material chat frontend
```
