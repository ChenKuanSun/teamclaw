...
**Files:**
- Modify: `apps/enterprise-admin/src/app/features/config/config.component.ts`
- Create: `apps/enterprise-admin/src/app/features/config/config-add-dialog.component.ts`
...
Run: `npx nx serve enterprise-admin`
...
**Files:**
- Modify: `apps/enterprise-admin/src/app/features/team-detail/team-detail.component.ts`
...
**Files:**
- Modify: `apps/enterprise-admin/src/app/features/team-detail/team-detail.component.ts` — `removeMember()`
- Modify: `apps/enterprise-admin/src/app/features/teams/teams.component.ts` — `deleteTeam()`
- Modify: `apps/enterprise-admin/src/app/features/api-keys/api-keys.component.ts` — `removeKey()`

**Context:** `ConfirmDialogComponent` already exists at `apps/enterprise-admin/src/app/shared/confirm-dialog.component.ts` but is never used. Replace all `confirm()` calls.
...
**Files:**
- Create: `apps/enterprise-chat/src/app/services/session.service.ts`
- Create: `apps/enterprise-chat/src/app/pages/session-init/session-init.component.ts`
- Modify: `apps/enterprise-chat/src/app/pages/chat/chat.component.ts`
- Modify: `apps/enterprise-chat/src/app/app.routes.ts`
