...
**Files:**
- Modify: `apps/enterprise-admin/src/app/services/admin-api.service.ts`
...
```bash
git add apps/enterprise-admin/src/app/services/admin-api.service.ts
...
**Files:**
- Create: `apps/enterprise-admin/src/app/features/dashboard/onboarding-wizard.component.ts`
- Modify: `apps/enterprise-admin/src/app/features/dashboard/dashboard.component.ts`
...
In `apps/enterprise-admin/src/app/features/dashboard/dashboard.component.ts`:
...
```bash
git add apps/enterprise-admin/src/app/features/dashboard/ apps/enterprise-admin/src/app/services/admin-api.service.ts
...
**Files:**
- Create: `apps/enterprise-chat/src/app/pages/signup/signup.component.ts`
- Create: `apps/enterprise-chat/src/app/pages/signup/signup.component.html`
- Create: `apps/enterprise-chat/src/app/pages/signup/signup.component.scss`
- Modify: `apps/enterprise-chat/src/app/services/auth.service.ts` — add `signUp()` method
- Modify: `apps/enterprise-chat/src/app/app.routes.ts` — add `/signup` route
- Modify: `apps/enterprise-chat/src/app/pages/login/login.component.html` — add "Sign up" link
...
In `apps/enterprise-chat/src/app/services/auth.service.ts`, add:
```typescript
...
```bash
git add apps/enterprise-chat/src/app/pages/signup/ apps/enterprise-chat/src/app/services/auth.service.ts
...
**Files:**
- Create: `apps/enterprise-chat/src/app/pages/verify/verify.component.ts`
- Create: `apps/enterprise-chat/src/app/pages/verify/verify.component.html`
- Modify: `apps/enterprise-chat/src/app/app.routes.ts` — add `/verify` and `/signup` routes
- Modify: `apps/enterprise-chat/src/app/pages/login/login.component.html` — add signup link
...
In `apps/enterprise-chat/src/app/app.routes.ts`, add before the `path: ''` block:
```typescript
  {
    path: 'signup',
    loadComponent: () =>
...
In `apps/enterprise-chat/src/app/pages/login/login.component.html`, replace the footer (line 67-71):
```html
      <footer class="card-footer">
        <p class="footer-text">
...
```bash
git add apps/enterprise-chat/src/app/pages/verify/ apps/enterprise-chat/src/app/pages/signup/ apps/enterprise-chat/src/app/pages/login/ apps/enterprise-chat/src/app/app.routes.ts
