...
const makeEvent = (overrides: Partial<APIGatewayProxyEventV2WithJWTAuthorizer> = {}): APIGatewayProxyEventV2WithJWTAuthorizer =>
  ({
    version: '2.0',
    routeKey: 'GET /admin/analytics/usage-by-provider',
    rawPath: '/admin/analytics/usage-by-provider',
    rawQueryString: '',
    headers: {},
    requestContext: {
      http: { method: 'GET', path: '/admin/analytics/usage-by-provider', protocol: 'HTTP/1.1', sourceIp: '127.0.0.1', userAgent: 'test' },
