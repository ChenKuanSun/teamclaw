  ...
  beforeAll(() => {
    const app = new App({
      context: {
        ...
        ['vpc-provider:account=023371593417:filter.vpc-name=teamclaw-dev:region=us-west-1:returnAsymmetricSubnets=true']:
          {
            vpcId: 'vpc-12345',
            vpcCidrBlock: '10.0.0.0/16',
            ownerAccountId: '023371593417',
    ...
    const stack = new ClusterStack(app, 'TestCluster', {
      ...
      env: { account: '023371593417', region: 'us-west-1' },
    });
