...
import { RemovalPolicy, Stack, aws_cognito, aws_ssm } from 'aws-cdk-lib';
...
export class AdminCognitoStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: StackPropsWithEnv) {
    super(scope, id, {
      ...props,
      description: 'TeamClaw Admin: Cognito User Pool for Admin Panel',
    });
    ...
    // ==========================================================
    this.adminUserPool = new aws_cognito.UserPool(this, id + 'AdminUserPool', {
