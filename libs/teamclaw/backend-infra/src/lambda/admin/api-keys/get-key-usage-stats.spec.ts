...
const makeEvent = (overrides: Partial<APIGatewayProxyEventV2WithJWTAuthorizer> = {}): APIGatewayProxyEventV2WithJWTAuthorizer =>
  ({
    version: '2.0',
    routeKey: 'GET /admin/api-keys/usage-stats',
    rawPath: '/admin/api-keys/usage-stats',
    rawQueryString: '',
    headers: {},
    requestContext: {
      http: { method: 'GET', path: '/admin/api-keys/usage-stats', protocol: 'HTTP/1.1', sourceIp: '127.0.0.1', userAgent: 'test' },
