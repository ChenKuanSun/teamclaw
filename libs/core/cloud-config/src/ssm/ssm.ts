...
export const TC_SSM_PARAMETER = {
  [ENVIRONMENT.PROD]: {
    ...
    DYNAMODB: {
      ...
      INTEGRATIONS_TABLE_ARN: `/tc/${ENVIRONMENT.PROD}/dynamodb/integrationsTableArn`,
      INTEGRATIONS_TABLE_NAME: `/tc/${ENVIRONMENT.PROD}/dynamodb/integrationsTableName`,
    },
    ADMIN_COGNITO: {
    ...
    ADMIN_API: {
      ...
      LAMBDA: {
        ...
        // Integrations (Admin)
        LIST_INTEGRATIONS_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/listIntegrationsLambdaName`,
        GET_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/getIntegrationLambdaName`,
        UPDATE_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/updateIntegrationLambdaName`,
        DELETE_INTEGRATION_CRED_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/deleteIntegrationCredLambdaName`,
        LIST_TEAM_OVERRIDES_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/listTeamOverridesLambdaName`,
        UPDATE_TEAM_OVERRIDE_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/updateTeamOverrideLambdaName`,
        DELETE_TEAM_CRED_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/deleteTeamCredLambdaName`,
        // Integrations (User)
        LIST_USER_INTEGRATIONS_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/listUserIntegrationsLambdaName`,
        CONNECT_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/connectIntegrationLambdaName`,
        DISCONNECT_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.PROD}/admin-api/lambda/disconnectIntegrationLambdaName`,
      },
    },
  },
  [ENVIRONMENT.DEV]: {
    ...
    DYNAMODB: {
      ...
      INTEGRATIONS_TABLE_ARN: `/tc/${ENVIRONMENT.DEV}/dynamodb/integrationsTableArn`,
      INTEGRATIONS_TABLE_NAME: `/tc/${ENVIRONMENT.DEV}/dynamodb/integrationsTableName`,
    },
    ADMIN_COGNITO: {
    ...
    ADMIN_API: {
      ...
      LAMBDA: {
        ...
        // Integrations (Admin)
        LIST_INTEGRATIONS_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/listIntegrationsLambdaName`,
        GET_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/getIntegrationLambdaName`,
        UPDATE_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/updateIntegrationLambdaName`,
        DELETE_INTEGRATION_CRED_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/deleteIntegrationCredLambdaName`,
        LIST_TEAM_OVERRIDES_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/listTeamOverridesLambdaName`,
        UPDATE_TEAM_OVERRIDE_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/updateTeamOverrideLambdaName`,
        DELETE_TEAM_CRED_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/deleteTeamCredLambdaName`,
        // Integrations (User)
        LIST_USER_INTEGRATIONS_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/listUserIntegrationsLambdaName`,
        CONNECT_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/connectIntegrationLambdaName`,
        DISCONNECT_INTEGRATION_LAMBDA_NAME: `/tc/${ENVIRONMENT.DEV}/admin-api/lambda/disconnectIntegrationLambdaName`,
      },
    },
  },
};
